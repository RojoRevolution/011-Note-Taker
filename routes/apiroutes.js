...
module.exports = (app) => {
    ...
    // =========================
    // Note: I created this initially when figuring out how to delete items. I found it's actually not needed to delete, but I'm leaving it in the project simply for future reference.
